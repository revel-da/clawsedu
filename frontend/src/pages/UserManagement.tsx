                                ...
                                <div>
                                    <div style={{ fontWeight: 500, fontSize: '14px' }}>
                                        ...
                                        {user.role === 'platform_admin' && (
                                            <span style={{ marginLeft: '6px', fontSize: '10px', background: 'var(--accent-color)', color: '#fff', borderRadius: '4px', padding: '1px 6px' }}>{isChinese ? '管理员' : 'Admin'}</span>
                                        )}
                                    </div>
                            ...
                            {editingUserId === user.id && (
                                <div className="card" style={{
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '16px' }}>
                                        ...
                                        <div className="form-group">
                                            <label className="form-label" style={{ fontSize: '11px' }}>
                                                {t('enterprise.users.maxAgents', isChinese ? '最多学习助手' : 'Max assistants')}
                                            </label>
                                            <input
                                                className="form-input"
                                                type="number" min={0}
                                        ...
                                        <div className="form-group">
                                            <label className="form-label" style={{ fontSize: '11px' }}>
                                                {t('enterprise.users.agentTTL', isChinese ? '助手存活时长(h)' : 'Assistant TTL (hours)')}
                                            </label>
                                            <input
                                                className="form-input"
                                                type="number" min={1}
