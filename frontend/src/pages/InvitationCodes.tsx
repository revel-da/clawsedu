    ...
    return (
        <div className="content-area" style={{ maxWidth: '900px', margin: '0 auto', padding: '32px 24px' }}>
            ...
            <h2 style={{ fontSize: '20px', fontWeight: 600, marginBottom: '4px' }}>
                {t('enterprise.invites.pageTitle', 'Join Codes')}
            </h2>
            <p style={{ fontSize: '13px', color: 'var(--text-tertiary)', marginBottom: '24px' }}>
                {t('enterprise.invites.pageDesc', 'Manage join codes for registration.')}
            </p>

            {/* Batch Create */}
            <div className="card" style={{ padding: '16px', marginBottom: '16px' }}>
                <div style={{ fontSize: '12px', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '12px' }}>
                    {t('enterprise.invites.createTitle', 'Generate Join Codes')}
                </div>
            ...
            <div className="card" style={{ padding: '16px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                    <div style={{ fontSize: '12px', fontWeight: 600, color: 'var(--text-secondary)' }}>
                        {t('enterprise.invites.listTitle', 'All Join Codes')} ({total})
                    </div>
