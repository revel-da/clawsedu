...
class LLMModel(Base):
    ...
    input_cost_per_million: Mapped[int | None] = mapped_column(Integer, nullable=True)
    output_cost_per_million: Mapped[int | None] = mapped_column(Integer, nullable=True)
    free_tokens_per_month: Mapped[int | None] = mapped_column(Integer, nullable=True)
