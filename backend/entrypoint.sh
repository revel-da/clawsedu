...
echo "[entrypoint] Step 1: Running seed script (tables + initial data)..."
python seed.py

echo "[entrypoint] Step 2: Applying safe column patches..."
...
echo "[entrypoint] Step 3: Running alembic migrations..."
